...
public class Deliverable4{
	public static void main(String args []){
		...
		/*System.out.println("readFile(): " + readFileTime + " ns");
		System.out.println("createHashMap(): " + hashMapTime + " ns");
		System.out.println("checkElements(): " + checkElementsTime + " ns");
		System.out.println("generateElementAbbr(): " + generateElementAbbrTime + " ns");
		System.out.println("generateElementNameTime(): " + generateElementNameTime + " ns");*/
